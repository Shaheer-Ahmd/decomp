...
Value *ScalarExprEmitter::EmitCompare(const BinaryOperator *E,
  ...
  if (const MemberPointerType *MPT = LHSTy->getAs<MemberPointerType>()) {
    ...
    if (BOInfo.isFixedPointOp()) {
      ...
      Result = !IsSignaling ? Builder.CreateFCmp(FCmpOpc, LHS, RHS, "cmp")
                            : Builder.CreateFCmpS(FCmpOpc, LHS, RHS, "cmp");
    ...
    Result = (E->getOpcode() == BO_EQ)
                 ? Builder.CreateAnd(ResultR, ResultI, "and.ri")
                 : Builder.CreateOr(ResultR, ResultI, "or.ri");
  }
